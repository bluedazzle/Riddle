...
class User(ExportModelOperationsMixin("User"), BaseModel):
    ...
    android_id = models.CharField(max_length=128, default='', null=True, blank=True)
    imei = models.CharField(max_length=128, default='', null=True, blank=True)
    oaid = models.CharField(max_length=128, default='', null=True, blank=True)
    mac = models.CharField(max_length=128, default='', null=True, blank=True)
